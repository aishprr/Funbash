...
alias pico='ssh pico75203@shell2014.picoctf.com'
...
# alias os='cd ~/private/410-projects/P4'
# alias osafs='cd ~/private/410/15410-s16'
alias sshcmu='ssh apremren@unix.andrew.cmu.edu'
alias amma='cd ~/Private/sixty-plus/sixty-plus-1'
alias gits='git status'
alias gitl="git log --graph --all --pretty=format:'%C(yellow)%h -%C(auto)%d %C(bold cyan)%s %C(bold white)(%cr)%Creset %C(dim white)<%an>'"
alias gitd='git diff'
alias gitck='git checkout'
alias findword='grep -rnw . -e'
alias vc='make veryclean'
export PATH=/afs/cs.cmu.edu/academic/class/15410-s16/bin:$PATH
# get_cs_afs_access
export SIMICS_CPU_COUNT=6
eval $(thefuck --alias)
alias sshece='ssh apremren@ece001.ece.cmu.edu'
alias loadrec='wget --recursive --no-clobber --page-requisites --html-extension --convert-links --restrict-file-names=windows --random-wait --no-parent'
